...
export async function findInboxImage(stem: string, inboxDirectory = INBOX_DIRECTORY): Promise<string> {
  ...
  throw new Error(`Image ${stem} introuvable dans ${inboxDirectory} (JPEG attendu).`);
}
