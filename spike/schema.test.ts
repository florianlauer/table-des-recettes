...
import { extractionSchema, normalizeExtraction, repairExtraction } from "../src/lib/recipe-schema.js";
...
describe("extraction schema", () => {
  ...
  it("repairs a numeric field returned as text, and reports every repair", () => {
    ...
    const recipe = (value as { recipes: Array<Record<string, any>> }).recipes[0]!;
    ...
    expect(repairs[0]).toEqual({ path: "recipes.0.servings", from: "6 à 8 personnes", to: 6 });
  });
