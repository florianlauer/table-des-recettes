...
- Renseigne servings comme un nombre de portions ; utilise null si l'information n'est pas présente ou reste illisible.
...
- quantity est un nombre, tandis que unit et label sont textuels. Ils décrivent la ligne raw sans perdre son texte. Utilise null pour chaque sous-champ absent ou incertain ; n'invente aucune valeur.
